...
global.dfail = (type, m, conn) => {
  ...
  const msg = {
  owner: `🦄✨ *Owner's Spell*\n${userTag}, only the *Unicorn Owner* can cast this command!`,
  moderator: `🦄🛡️ *Moderator's Spell*\n${userTag}, this command is reserved for *Unicorn Moderators*!`,
  premium: `🌟🦄 *Premium Portal*\n${userTag}, this feature is for *Unicorn Premium Members* only!`,
  group: `👥🦄 *Group Realm*\n${userTag}, this command works only in *Group Chats*!`,
  private: `📩🦄 *Private Path*\n${userTag}, use this command in *Private Chat* only!`,
  admin: `🦄🔱 *Admin Channel*\n${userTag}, this command is only for *Group Admins*!`,
  botAdmin: `🤖🦄 *Bot Power Needed*\n${userTag}, the bot must be an *Admin* to run this spell!`,
  unreg: `📝🦄 *Registration Needed*\n${userTag}, please register first:\n\n*#register name.age*\n\nExample: *#register ${m.name}.18*`,
  nsfw: `🚫🦄 *NSFW Disabled*\n${userTag}, NSFW is not active. Ask a *Group Admin* to enable it.`,
  restrict: `⚙️🦄 *Feature Locked*\n${userTag}, this magical feature is currently *disabled*!`,
  }[type]
